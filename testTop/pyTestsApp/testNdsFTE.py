...
class TestNdsFTE(ParametrizedTestCase): #unittest.TestCase
    ...
    def setUp(self):
        try:
            ...
            appName = 'ndsex1'                              #Ex: 
            libFile = 'libnds3-'+'DeviceFTE'+'.so'    #Ex: DeviceVectorDBL
            subsFile = 'FTE'+'.substitutions'          #Ex: WaveForm
            DeviceName = "B-0"                              #Ex: B-0
            DriverName = "DeviceFTE"                   #Ex: DeviceVectorDBL
            CBS1 = 'TEST'
            CBS2 = 'FCT0'
            BOARDTYPE = 'B'
            BOARDTYPEIDX='0'
            ...
            self.userList=[ ('TerminalSet'              ,int(1)        ),
                   ('ModeSet'                  ,int(1)        ),
                   ('StartTimeSet'             ,[int(1),int(1)]        ),
                   ('StopTimeSet'              ,[int(1),int(1)]        ),             
                   ('LevelSet'                 ,int(1)        ),        
                   ('PeriodNsecSet'            ,int(1)        ),         
                   ('DutyCycleSet'             ,int(1)        ),  
                   ('Set'                      ,int(1)        ),          
                   ('SetCode'                  ,int(0)        ),    
                   ('SetStatus'                ,[int(1),int(1),]        ),#supressing FTE
                   ('TerminalSuppress'         ,int(1)        ),    
                   ('StartTimeSuppress'        ,[int(1),int(1),int(1),int(1)]        ),    
                   ('ModeSuppress'             ,int(1)        ),    
                   ('AllSuppress'              ,int(1)        ),    
                   ('Suppress'                 ,int(1)        ),    
                   ('SuppressCode'             ,int(0)        ),    
                   ('SuppressStatus'           ,[int(1),int(1)]        ),#Change period of scheduled clock generation
                   ('TerminalChgPeriod'        ,int(1)        ),
                   ('PeriodChgPeriod'          ,int(1)        ),
                   ('ChgPeriod'                ,int(1)        ),
                   ('ChgPeriodCode'            ,int(0)        ),
                   ('ChgPeriodStatus'          ,[int(1),int(1)]        ),#Status of pending FTEs
                   ('TerminalPending'          ,int(1)        ),
                   ('PendingValue'             ,int(1)        ),            
                   ('PendingCode'              ,int(0)        ),    
                   ('PendingStatus'            ,[int(1),int(1)]        ),    
                   ('Maximum'                  ,int(0)        ),    
