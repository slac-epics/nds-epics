...
class TestNdsDigitalIO(ParametrizedTestCase): #unittest.TestCase
    ...
    def setUp(self):
        try:
            ...
            appName = 'ndsex1'                              #Ex: 
            libFile = 'libnds3-'+'DeviceDigitalIO'+'.so'    #Ex: DeviceVectorDBL
            subsFile = 'DigitalIO'+'.substitutions'          #Ex: WaveForm
            DeviceName = "B-0"                              #Ex: B-0
            DriverName = "DeviceDigitalIO"                   #Ex: DeviceVectorDBL
            CBS1 = 'TEST'
            CBS2 = 'FCT0'
            BOARDTYPE = 'B'
            BOARDTYPEIDX='0'
            NODE_NAME = 'DigitalIOI32Node'
            ...
            self.userList=[ ('DataIn'                   ,arrODATA        ),
                   ('STM-setState'             ,int(4)         ),
                   ('STM-setState'          ,int(7)        ),
                   ('DataOut'                  ,arrODATA        ),
                   ('STM-setState'          ,int(4)        ),
                   ('DataOutMask'              ,32*[1]         ),
                   ('DataOutMask_RBV'          ,32*[0]         ),             
                   ('Decimation'               ,int(0)         ),        
                   ('VoltLevelHigh'            ,floODATA        ),         
                   ('VoltLevelHigh_RBV'        ,int(0)         ),  
                   ('VoltLevelLow'             ,floODATA        ),          
                   ('VoltLevelLow_RBV'         ,int(0)         ),    
                   ('ChannelDir'               ,npaZDATA        ),
                   ('ChannelDir_RBV'           ,npaODATA        ),    
                   ('NumberOfPushedDataBlocks' ,int(30)        ),    
