...
class TestNdsRouting(unittest.TestCase): #unittest.TestCase
    ...
    def setUp(self):
        try:
            ...
            self.userList=[ ('ClkSrc'                   ,int(1)        ),#route clocks
                   ('ClkDst'                   ,int(1)        ),
                   ('ClkSet'                   ,int(1)        ),
                   ('ClkSetCode'               ,int(1)        ),             
            ...
            iocCmd =  self.ioc.iocCommandCompose(appName, libFile,subsFile,DeviceName,DriverName)
            print("")
            print(iocCmd) 
